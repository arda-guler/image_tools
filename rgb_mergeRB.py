...
def main():
    ...
    print("\nRB merging " + filetitle + fileextension + "\n")
    ...
    if channel_num == 3:
        for y in range(image1.size[1]):
            for x in range(image1.size[0]):
                i += 1
                r, g, b = pixels1[x, y][0], 0, pixels2[x, y][2]
                pixels1[x, y] = (r, g, b)
    ...
    # R, G, B, Alpha channels
        ...
        for y in range(image1.size[1]):
            for x in range(image1.size[0]):
                r, g, b, a = pixels1[x, y][0], 0, pixels2[x, y][2], pixels1[x, y][3] + 0 + pixels2[x, y][3]
                pixels1[x, y] = (r, g, b, a)
    ...
    image1.save(filetitle + "_rbFilterMerged" + fileextension)
